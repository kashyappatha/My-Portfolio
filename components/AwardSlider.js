...
const awardData = [
  {
    ...
    technplpgy: 'PHP and MySql Database.',
      ...
      awardData.map((item, index) => {
        ...
        return <SwiperSlide key={index}>
          <motion.div variants={fadeIn('down', 0.4)} initial='hidden' animate='show' exit='hidden'>
            <div className="bg-[rgba(65,47,123,0.15)] h-max rounded-lg px-5 py-3 flex sm:flex-col gap-x-4 sm:gap-x-0 group  hover:bg-[rgba(89,169,0.15) transition-all duration-300] ">
