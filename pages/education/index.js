...
const About = () => {
  return (
<div className="h-full bg-primary/30 py-24 md:py-36 xl:py-48 text-center xl:text-center overflow-y-hidden">
<motion.h1 
        variants={fadeIn()}
        initial="hidden"
        animate="show"
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-2 p-8 md:p-4 overflow-y-hidden md:overflow-visible">
